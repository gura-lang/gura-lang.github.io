...
<p>
<div><strong style="text-decoration:underline">array@T.rands@normal</strong></div>
<div style="margin-bottom:1em"><code>array@T.rands@normal(dims[]:number, mu?:number, sigma?:number):static:map {block?}</code></div>
