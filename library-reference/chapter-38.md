...
{% raw %}
<h1><span class="caption-index-1">38</span><a name="anchor-38"></a>opengl Module</h1>
<p>
...
<div style="margin-bottom:1em"><code>opengl.glBitmap(width:number, height:number, xorig:number, yorig:number, xmove:number, ymove:number, bitmap:array@uchar:nil:nomap):map:void</code></div>
...
<div style="margin-bottom:1em"><code>opengl.glSelectBuffer(buffer:array@uint:nil:nomap):void</code></div>
