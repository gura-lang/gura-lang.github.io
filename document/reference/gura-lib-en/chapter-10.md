...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.context#set_miter_limit(limit:number):reduce</code></div>
<p>
...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.context#curve_to(x1:number, y1:number, x2:number, y2:number, x3:number, y3:number):map:reduce</code></div>
<p>
...
<div class="h5">cairo.context#rel_curve_to</div>
...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.context#translate(tx:number, ty:number):reduce</code></div>
<p>
...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.context#glyph_extents(glyphs:cairo.glyph) {block?}</code></div>
<p>
...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.device#finish():reduce</code></div>
...
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_font_options()</code></div>
<p>
...
<div class="h5">cairo.surface#get_content</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_content()</code></div>
<p>
...
<div class="h5">cairo.surface#mark_dirty</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#mark_dirty():reduce</code></div>
<p>
...
<div class="h5">cairo.surface#mark_dirty_rectangle</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#mark_dirty_rectangle(x:number, y:number, width:number, height:number):reduce</code></div>
<p>
...
<div class="h5">cairo.surface#set_device_offset</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#set_device_offset(x_offset:number, y_offset:number):reduce</code></div>
<p>
...
<div class="h5">cairo.surface#get_device_offset</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_device_offset()</code></div>
<p>
This function returns the previous device offset set by cairo.surface#set_device_offset().
</p>
<div class="h5">cairo.surface#set_fallback_resolution</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#set_fallback_resolution(x_pixels_per_inch:number, y_pixels_per_inch:number):reduce</code></div>
<p>
...
<div class="h5">cairo.surface#get_fallback_resolution</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_fallback_resolution()</code></div>
<p>
...
<div class="h5">cairo.surface#get_type</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_type()</code></div>
<p>
This function returns the type of the backend used to create a surface. See cairo_surface_type_t for available types.
</p>
<div class="h5">cairo.surface#copy_page</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#copy_page():reduce</code></div>
<p>
...
<div class="h5">cairo.surface#show_page</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#show_page():reduce</code></div>
<p>
...
<div class="h5">cairo.surface#has_show_text_glyphs</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#has_show_text_glyphs()</code></div>
<p>
...
<div class="h5">cairo.surface#set_mime_data</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#set_mime_data():reduce</code></div>
<div class="h5">cairo.surface#get_mime_data</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#get_mime_data()</code></div>
<div class="h5">cairo.surface#supports_mime_type</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#supports_mime_type()</code></div>
<div class="h5">cairo.surface#map_to_image</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#map_to_image(extents:cairo.rectangle_int)</code></div>
<div class="h5">cairo.surface#unmap_image</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#unmap_image()</code></div>
<div class="h5">cairo.surface#write_to_png</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.surface#write_to_png(stream:stream:w):reduce</code></div>
...
<div class="h5">cairo.image_surface.create</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface.create(image:image):static {block?}</code></div>
<div class="h5">cairo.image_surface.create_from_png</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface.create_from_png(stream:stream:r):static {block?}</code></div>
<div class="h5">cairo.image_surface#get_format</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface#get_format()</code></div>
<div class="h5">cairo.image_surface#get_width</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface#get_width()</code></div>
<div class="h5">cairo.image_surface#get_height</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface#get_height()</code></div>
<div class="h5">cairo.image_surface#get_stride</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.image_surface#get_stride()</code></div>
...
<div class="h5">cairo.pdf_surface.create</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.pdf_surface.create(stream:stream:w, width_in_points:number, height_in_points:number):static {block?}</code></div>
<div class="h5">cairo.pdf_surface#restrict_to_version</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.pdf_surface#restrict_to_version(version:number):reduce</code></div>
<div class="h5">cairo.pdf_surface#set_size</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.pdf_surface#set_size(width_in_points:number, height_in_points:number):reduce</code></div>
...
<div class="h5">cairo.svg_surface.create</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.svg_surface.create(stream:stream:w, width_in_points:number, height_in_points:number):static {block?}</code></div>
<div class="h5">cairo.svg_surface#restrict_to_version</div>
<div class="mb-2"><i class="fas fa-caret-right mr-2"></i><code>cairo.svg_surface#restrict_to_version(version:number):reduce</code></div>
